...
<body class="entero1">
    ...
    <header>
        <nav class="navbar custom-header">
            <div class="container-fluid">
                <h5>Bienvenido Señ@r <?php echo $fila['nombre']; ?> Tu Rol Es <?php echo $fila['tipo_user']; ?></h5>
                <form method="post">
    ...
    <section class="container con my-5">
        <div class="row justify-content-center contas">

            <!-- Card 1 -->
            <div class="col-md-4 mb-4 d-flex justify-content-center">
                <a href="edit_us.php" class="text-decoration-none text-dark w-100">
                    <div class="card custom text-center shadow-lg rounded-4 p-3 h-100">
                        <div class="card-body">
                            <i class="bi bi-person-circle text-white fs-1"></i>
                            <h4 class="mt-3 text-white">USUARIOS</h4>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <!-- Card 2 -->
            <div class="col-md-4 mb-4 d-flex justify-content-center">
                <a href="edit_mas.php" class="text-decoration-none text-dark w-100">
                    <div class="card custom text-center shadow-lg rounded-4 p-3 h-100">
                        <div class="card-body">
                            <i class="bi bi-gitlab text-white fs-1"></i>
                            <h4 class="mt-3 text-white">MASCOTAS</h4>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-4 mb-4 d-flex justify-content-center">
                <a href="edit_arti.php" class="text-decoration-none text-dark w-100">
                    <div class="card custom text-center shadow-lg rounded-4 p-3 h-100">
                        <div class="card-body">
                            <i class="bi bi-cart-check-fill text-white fs-1"></i>
                            <h4 class="mt-3 text-white">ARTICULOS</h4>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-4 mb-4 d-flex justify-content-center">
                <a href="ventas.php" class="text-decoration-none text-dark w-100">
                    <div class="card custom text-center shadow-lg rounded-4 p-3 h-100">
                        <div class="card-body">
                            <i class="bi bi-cart-check-fill text-white fs-1"></i>
                            <h4 class="mt-3 text-white">VENTAS</h4>
                        </div>
                    </div>
                </a>
            </div>

            <button class="btn btn-outline-light btn-largo" onclick="window.history.back()">
